    ...
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="index.html"> <span
            class="logo-name">MIABESANTE</span><img alt="image" src="{{ asset('assets/img/heart.png') }}" class="header-logo" />
        </a>
      </div>
      <ul class="sidebar-menu">
        <li class="menu-header">Menu</li>
        @auth('web')
            <li class="dropdown {{ Request::is('accueil') ? 'active' : '' }}">
            <a href="{{ route('accueil') }}" class="nav-link"><i data-feather="monitor"></i><span>Accueil</span></a>
            </li>
            <li class="dropdown {{ Request::is('modificaion-profil') ? 'active' : '' }} ">
                <a href="{{ route('modif_profil') }}" class="nav-link"><i data-feather="users"></i><span>Profil</span></a>
            </li>
        @endauth
        @auth('admin')
        <li class="dropdown {{ Request::is('ajouter-Element') ? 'active' : '' }} ">
            <a href="{{ route('form_element') }}" class="nav-link"><i data-feather="users"></i><span>Elément</span></a>
          </li>
          <li class="dropdown {{ Request::is('dashboard-composant') ? 'active' : '' }} ">
            <a href="{{ route('dashboardComposant') }}" class="nav-link"><i data-feather="users"></i><span>Composant</span></a>
          </li>
        @endauth
        <li class="dropdown  ">
            <a href="{{ route('logout') }}" class="nav-link"><i data-feather="users"></i><span>Deconnexion</span></a>
          </li>
        <!--li class="dropdown">
          <a href="#" class="menu-toggle nav-link has-dropdown"><i
              data-feather="briefcase"></i><span>Profil</span></a>
        </li>
        <li class="dropdown">
